...
export const CreateProductTypeForm = () => {
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="product-type-create-form"
    >
      <KeyboundForm
      ...
      >
        <RouteFocusModal.Body
          ...
          data-testid="product-type-create-form-body"
        >
          <div className="flex w-full max-w-[720px] flex-col gap-y-8">
            <div data-testid="product-type-create-form-header-section">
              <Heading data-testid="product-type-create-form-heading">
                {t('productTypes.create.header')}
              </Heading>
              <Text
                size="small"
                className="text-ui-fg-subtle"
                data-testid="product-type-create-form-hint"
              >
                ...
                render={({ field }) => {
                  return (
                    <Form.Item data-testid="product-type-create-form-value-item">
                      <Form.Label data-testid="product-type-create-form-value-label">
                        {t('productTypes.fields.value')}
                      </Form.Label>
                      <Form.Control data-testid="product-type-create-form-value-control">
                        <Input
                          {...field}
                          data-testid="product-type-create-form-value-input"
                        />
                      </Form.Control>
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="product-type-create-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
