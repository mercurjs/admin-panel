    ...
    >
      ...
      >
        ...
        <RouteFocusModal.Body
          className="flex flex-col items-center pt-[72px]"
          data-testid="create-customer-group-form-body"
        >
          <div
            className="flex size-full max-w-[720px] flex-col gap-y-8"
            data-testid="create-customer-group-form-content"
          >
            ...
            <div
              ...
              data-testid="create-customer-group-form-fields"
            >
              <Form.Field
                ...
                render={({ field }) => (
                  <Form.Item data-testid="create-customer-group-form-name-item">
                    <Form.Label data-testid="create-customer-group-form-name-label">
                      {t('fields.name')}
                    </Form.Label>
        ...
        <RouteFocusModal.Footer data-testid="create-customer-group-form-footer">
          <div
            ...
            data-testid="create-customer-group-form-footer-actions"
          >
