    ...
    >
      ...
      >
        <RouteDrawer.Body
          ...
          data-testid="edit-customer-group-form-body"
        >
          <Form.Field
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="edit-customer-group-form-name-item">
                  <Form.Label data-testid="edit-customer-group-form-name-label">
                    {t('fields.name')}
                  </Form.Label>
        ...
        <RouteDrawer.Footer data-testid="edit-customer-group-form-footer">
          <div
            ...
            data-testid="edit-customer-group-form-footer-actions"
          >
