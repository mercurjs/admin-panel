  ...
  return (
    <Container data-testid="request-seller-list-container">
      <div
        ...
        data-testid="request-seller-list-header"
      >
        <div>
      ...
      <div
        ...
        data-testid="request-seller-list-content"
      >
        ...
        <Table data-testid="request-seller-list-table">
          <Table.Header data-testid="request-seller-list-table-header">
            <Table.Row>
              <Table.HeaderCell data-testid="request-seller-list-table-header-name">
                Name
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-seller-list-table-header-email">
                Email
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-seller-list-table-header-date">
                Date
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-seller-list-table-header-status">
                Status
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-seller-list-table-header-actions">
                Actions
              </Table.HeaderCell>
            </Table.Row>
          </Table.Header>
          <Table.Body data-testid="request-seller-list-table-body">
            {requests?.map((request, index) => {
              ...
              return (
                <Table.Row
                  key={request.id}
                  data-testid={`request-seller-list-table-row-${index}`}
                >
                  <Table.Cell data-testid={`request-seller-list-table-row-${index}-name`}>
                    {(requestData.seller as Record<string, unknown>)?.name as string}
                  </Table.Cell>
