...
export function ResolveReturnRequestPrompt({ open, id, accept, close, onSuccess }: Props) {
  ...
  return (
    <Prompt
      open={open}
      data-testid={`resolve-return-request-prompt-${id}`}
    >
      <Prompt.Content data-testid={`resolve-return-request-prompt-${id}-content`}>
        ...
        <Prompt.Footer data-testid={`resolve-return-request-prompt-${id}-footer`}>
          <Button
            variant="secondary"
            onClick={close}
            data-testid={`resolve-return-request-prompt-${id}-cancel-button`}
          >
            Cancel
          </Button>
          <Button
            onClick={handleReview}
            data-testid={`resolve-return-request-prompt-${id}-submit-button`}
          >
            Submit
          </Button>
        </Prompt.Footer>
