  ...
  return (
    <Container data-testid="request-product-list-container">
      <div
        ...
        data-testid="request-product-list-header"
      >
        <div>
      ...
      <div
        ...
        data-testid="request-product-list-content"
      >
        ...
        <Table data-testid="request-product-list-table">
          <Table.Header data-testid="request-product-list-table-header">
            <Table.Row>
              <Table.HeaderCell data-testid="request-product-list-table-header-product">
                Product
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-product-list-table-header-submitted-by">
                Submitted By
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-product-list-table-header-variants">
                Variants
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-product-list-table-header-date">
                Date
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-product-list-table-header-status">
                Status
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-product-list-table-header-actions">
                Actions
              </Table.HeaderCell>
            </Table.Row>
          </Table.Header>
...
const ProductRequestsRow = ({
  ...
  return (
    <Table.Row
      key={request.id}
      data-testid={`request-product-list-table-row-${index}`}
    >
      <Table.Cell data-testid={`request-product-list-table-row-${index}-product`}>
        {requestData.title}
      </Table.Cell>
      <Table.Cell data-testid={`request-product-list-table-row-${index}-submitted-by`}>
        {request.seller?.name}
      </Table.Cell>
      ...
      <Table.Cell data-testid={`request-product-list-table-row-${index}-status`}>
