  ...
  return (
    <Container data-testid="request-review-remove-list-container">
      <div
        ...
        data-testid="request-review-remove-list-header"
      >
        <div>
      ...
      <div
        ...
        data-testid="request-review-remove-list-content"
      >
        ...
        <Table data-testid="request-review-remove-list-table">
          <Table.Header data-testid="request-review-remove-list-table-header">
            <Table.Row>
              <Table.HeaderCell data-testid="request-review-remove-list-table-header-submitted-by">
                Submitted By
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-review-remove-list-table-header-reason">
                Reason
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-review-remove-list-table-header-date">
                Date
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-review-remove-list-table-header-status">
                Status
              </Table.HeaderCell>
              <Table.HeaderCell data-testid="request-review-remove-list-table-header-actions">
                Actions
              </Table.HeaderCell>
            </Table.Row>
          </Table.Header>
          <Table.Body data-testid="request-review-remove-list-table-body">
            {requests?.map((request, index) => {
              ...
              return (
                <Table.Row
                  key={request.id}
                  data-testid={`request-review-remove-list-table-row-${index}`}
                >
                  <Table.Cell
                    data-testid={`request-review-remove-list-table-row-${index}-submitted-by`}
                  >
                    {request.seller?.name}
                  </Table.Cell>
                  <Table.Cell data-testid={`request-review-remove-list-table-row-${index}-reason`}>
