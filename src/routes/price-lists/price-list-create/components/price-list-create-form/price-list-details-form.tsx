          ...
          render={({ field: { onChange, ...rest } }) => (
            <Form.Item data-testid="price-list-details-form-type-item">
              <div className="flex flex-col gap-y-4">
                <div>
                  <Form.Label data-testid="price-list-details-form-type-label">
                    {t('priceLists.fields.type.label')}
                  </Form.Label>
                  <Form.Hint data-testid="price-list-details-form-type-hint">
            ...
            <Form.Field
              ...
              render={({ field }) => (
                <Form.Item data-testid="price-list-details-form-title-item">
                  <Form.Label data-testid="price-list-details-form-title-label">
                    {t('fields.title')}
                  </Form.Label>
                  <Form.Control data-testid="price-list-details-form-title-control">
                    <Input
                      {...field}
                      data-testid="price-list-details-form-title-input"
                    />
                  </Form.Control>
                ...
                <Form.Item data-testid="price-list-details-form-status-item">
                  ...
                  <Form.Control data-testid="price-list-details-form-status-control">
                    ...
                    >
                      <Select.Trigger
                        ref={ref}
                        data-testid="price-list-details-form-status-trigger"
                      >
          ...
          <Form.Field
            ...
            render={({ field }) => (
              <Form.Item data-testid="price-list-details-form-description-item">
                <Form.Label data-testid="price-list-details-form-description-label">
                  {t('fields.description')}
                </Form.Label>
                <Form.Control data-testid="price-list-details-form-description-control">
                  <Textarea
                    {...field}
                    data-testid="price-list-details-form-description-input"
                  />
                </Form.Control>
            ...
            <Form.Item data-testid="price-list-details-form-starts-at-item">
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div className="flex flex-col">
                  <Form.Label
                    optional
                    data-testid="price-list-details-form-starts-at-label"
                  >
            ...
            <Form.Item data-testid="price-list-details-form-ends-at-item">
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                <div className="flex flex-col">
                  <Form.Label
                    optional
                    data-testid="price-list-details-form-ends-at-label"
                  >
                    {t('priceLists.fields.endsAt.label')}
                  </Form.Label>
                  <Form.Hint data-testid="price-list-details-form-ends-at-hint">
          ...
          render={({ field }) => (
            <Form.Item data-testid="price-list-details-form-customer-group-item">
              <div>
                <Form.Label
                  optional
                  data-testid="price-list-details-form-customer-group-label"
                >
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 px-1.5">
                    <StackedFocusModal id="cg">
                      ...
                      <StackedFocusModal.Trigger asChild>
                        <Button
                          variant="secondary"
                          data-testid="price-list-details-form-customer-group-browse-button"
                        >
                          {t('actions.browse')}
                        </Button>
                      </StackedFocusModal.Trigger>
                  ...
                  {fields.length > 0 ? (
                    <div
                      ...
                      data-testid="price-list-details-form-customer-group-selected"
                    >
                        ...
                        {fields.map((field, index) => (
                          ...
                          >
                            <Text
                              size="small"
                              leading="compact"
                              data-testid={`price-list-details-form-customer-group-selected-${field.id}-name`}
                            >
                              {field.name}
                            </Text>
                            <IconButton
