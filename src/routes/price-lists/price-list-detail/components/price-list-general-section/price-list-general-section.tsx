...
export const PriceListGeneralSection = ({ priceList }: PriceListGeneralSectionProps) => {
  ...
  return (
    <Container
      ...
      data-testid="price-list-general-section-container"
    >
      <div
        className="flex items-center justify-between px-6 py-4"
        data-testid="price-list-general-section-header"
      >
        <Heading data-testid="price-list-general-section-title">{priceList.title}</Heading>
        <div className="flex items-center gap-x-4">
          <StatusBadge
            color={color}
            data-testid="price-list-general-section-status"
          >
            {text}
          </StatusBadge>
          <ActionMenu
      ...
      <div
        ...
        data-testid="price-list-general-section-type"
      >
        <Text
          leading="compact"
          size="small"
          weight="plus"
          data-testid="price-list-general-section-type-label"
        >
          {t('fields.type')}
        </Text>
        <Text
          ...
          data-testid="price-list-general-section-type-value"
        >
          {type}
        </Text>
      </div>
      <div
        className="grid grid-cols-2 items-center px-6 py-4 text-ui-fg-subtle"
        data-testid="price-list-general-section-description"
      >
        <Text
          leading="compact"
          size="small"
          weight="plus"
          data-testid="price-list-general-section-description-label"
        >
        ...
        <Text
          size="small"
          className="text-pretty"
          data-testid="price-list-general-section-description-value"
        >
      ...
      <div
        className="grid grid-cols-2 items-center px-6 py-4 text-ui-fg-subtle"
        data-testid="price-list-general-section-price-overrides"
      >
        <Text
          leading="compact"
          size="small"
          weight="plus"
          data-testid="price-list-general-section-price-overrides-label"
        >
        ...
        <Text
          size="small"
          className="text-pretty"
          data-testid="price-list-general-section-price-overrides-value"
        >
          {overrideCount || '-'}
        </Text>
      </div>
