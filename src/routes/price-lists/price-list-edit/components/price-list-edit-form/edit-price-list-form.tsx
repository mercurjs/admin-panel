...
export const PriceListEditForm = ({ priceList }: PriceListEditFormProps) => {
  ...
  return (
    <RouteDrawer.Form
      form={form}
      data-testid="price-list-edit-form"
    >
      <KeyboundForm
      ...
      >
        <RouteDrawer.Body
          ...
          data-testid="price-list-edit-form-body"
        >
          <Form.Field
            ...
            render={({ field: { onChange, ...field } }) => (
              <Form.Item data-testid="price-list-edit-form-type-item">
                <div>
                  <Form.Label data-testid="price-list-edit-form-type-label">
                    {t('priceLists.fields.type.label')}
                  </Form.Label>
                  <Form.Hint data-testid="price-list-edit-form-type-hint">
            ...
            <Form.Field
              ...
              render={({ field }) => (
                <Form.Item data-testid="price-list-edit-form-title-item">
                  <Form.Label data-testid="price-list-edit-form-title-label">
                    {t('fields.title')}
                  </Form.Label>
                  <Form.Control data-testid="price-list-edit-form-title-control">
                    <Input
                      {...field}
                      data-testid="price-list-edit-form-title-input"
                    />
                  </Form.Control>
            ...
            <Form.Field
              ...
              render={({ field }) => (
                <Form.Item data-testid="price-list-edit-form-description-item">
                  <Form.Label data-testid="price-list-edit-form-description-label">
                    {t('fields.description')}
                  </Form.Label>
                  <Form.Control data-testid="price-list-edit-form-description-control">
                    <Textarea
                      {...field}
                      data-testid="price-list-edit-form-description-input"
                    />
                  </Form.Control>
        ...
        <RouteDrawer.Footer
          className="shrink-0"
          data-testid="price-list-edit-form-footer"
        >
          <div className="flex items-center justify-end gap-x-2">
            <RouteDrawer.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="price-list-edit-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
            <Button
              ...
              type="submit"
              isLoading={isPending}
              data-testid="price-list-edit-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
