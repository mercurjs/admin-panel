...
export const CreateRegionForm = ({ currencies }: CreateRegionFormProps) => {
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="region-create-form"
    >
      <KeyboundForm
...
const CountryTag = ({
  ...
  return (
    <div
      className="flex h-7 items-center overflow-hidden rounded-md bg-ui-bg-field shadow-borders-base transition-fg hover:bg-ui-bg-field-hover"
