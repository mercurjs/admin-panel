...
const Canvas = ({
  ...
  return (
    <div
      ...
      data-testid="workflow-execution-timeline-canvas"
    >
      <div
        ref={dragConstraints}
            ...
            <div>
              ...
              >
                <DropdownMenu.Trigger
                  className="flex w-[50px] items-center justify-center border-r p-1 outline-none transition-fg hover:bg-ui-bg-base-hover focus-visible:bg-ui-bg-base-pressed active:bg-ui-bg-base-pressed disabled:text-ui-fg-disabled"
