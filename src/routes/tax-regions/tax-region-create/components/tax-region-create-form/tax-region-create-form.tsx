...
export const TaxRegionCreateForm = ({ parentId }: TaxRegionCreateFormProps) => {
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="tax-region-create-form"
    >
      <KeyboundForm
      ...
      >
        ...
        <RouteFocusModal.Body
          ...
          data-testid="tax-region-create-form-body"
        >
            ...
            <div className="flex w-full max-w-[720px] flex-col gap-y-8 px-2 py-16">
              <div data-testid="tax-region-create-form-header-section">
                <Heading
                  ...
                  data-testid="tax-region-create-form-heading"
                >
                ...
                <Text
                  ...
                  data-testid="tax-region-create-form-hint"
                >
                    ...
                    render={({ field }) => {
                      return (
                        <Form.Item data-testid="tax-region-create-form-country-item">
                          <Form.Label data-testid="tax-region-create-form-country-label">
                            {t('fields.country')}
                          </Form.Label>
                          <Form.Control data-testid="tax-region-create-form-country-control">
                            <CountrySelect
                              {...field}
                              data-testid="tax-region-create-form-country-select"
                            />
                          </Form.Control>
              ...
              <div
                ...
                data-testid="tax-region-create-form-default-tax-rate-section"
              >
                <div
                  className="flex items-center gap-x-1"
                  data-testid="tax-region-create-form-default-tax-rate-header"
                >
                  <Heading
                    level="h2"
                    className="!txt-compact-small-plus"
                    data-testid="tax-region-create-form-default-tax-rate-label"
                  >
                  ...
                  <Tooltip content={t('taxRegions.fields.defaultTaxRate.tooltip')}>
                    <InformationCircleSolid
                      className="text-ui-fg-muted"
                      data-testid="tax-region-create-form-default-tax-rate-tooltip"
                    />
                  </Tooltip>
                </div>
                <div className="flex flex-col gap-y-4">
                      ...
                      render={({ field }) => {
                        return (
                          <Form.Item data-testid="tax-region-create-form-name-item">
                            <Form.Label data-testid="tax-region-create-form-name-label">
                              {t('fields.name')}
                            </Form.Label>
                            <Form.Control data-testid="tax-region-create-form-name-control">
                              <Input
                                {...field}
                                data-testid="tax-region-create-form-name-input"
                              />
                            </Form.Control>
                        ...
                        return (
                          <Form.Item data-testid="tax-region-create-form-code-item">
                            ...
                            <Form.Control data-testid="tax-region-create-form-code-control">
                              <Input
                                {...field}
                                data-testid="tax-region-create-form-code-input"
                              />
                            </Form.Control>
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="tax-region-create-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            ...
            <Button
              ...
              type="submit"
              isLoading={isPending}
              data-testid="tax-region-create-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
