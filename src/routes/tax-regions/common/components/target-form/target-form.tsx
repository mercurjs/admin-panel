...
import { useProducts, useProductTypes, useShippingOptions, useStockLocations } from '@hooks/api';
import { useProductTableColumns, useProductTypeTableColumns } from '@hooks/table/columns';
