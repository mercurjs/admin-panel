...
import { useProducts, useProductTypes, useShippingOptions } from '@hooks/api';
  ...
  switch (type) {
    case TaxRateRuleReferenceType.PRODUCT:
      return {
        ...
        additional:
          products.products && products.count ? products.count - products.products.length : 0,
    ...
    case TaxRateRuleReferenceType.SHIPPING_OPTION:
      return {
        ...
        additional: shippingOptions.count
          ? shippingOptions.count - (shippingOptions.shipping_options?.length || 0)
          : 0,
