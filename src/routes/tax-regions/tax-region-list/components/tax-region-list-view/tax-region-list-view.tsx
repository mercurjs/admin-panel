...
import { useTaxRegionTable } from '@routes/tax-regions/common/hooks/use-tax-region-table.tsx';
...
export const TaxRegionListView = () => {
  ...
  return (
    <Container
      ...
      data-testid="tax-region-list-view-container"
    >
      <TaxRegionTable
        action={{
          to: 'create',
      ...
      >
        ...
        <Text
          ...
          data-testid="tax-region-list-view-hint"
        >
