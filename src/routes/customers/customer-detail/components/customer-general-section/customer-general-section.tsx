  ...
  return (
    ...
    >
      <div
        ...
        data-testid="customer-general-section-header"
      >
        <Heading data-testid="customer-general-section-email">{customer.email}</Heading>
        <div
          className="flex items-center gap-x-2"
          data-testid="customer-general-section-actions"
        >
          <StatusBadge
            color={statusColor}
            data-testid="customer-general-section-status-badge"
          >
            {statusText}
          </StatusBadge>
          <ActionMenu
      ...
      <div
        ...
        data-testid="customer-general-section-name-row"
      >
        <Text
          size="small"
          leading="compact"
          weight="plus"
          data-testid="customer-general-section-name-label"
        >
          {t('fields.name')}
        </Text>
        <Text
          size="small"
          leading="compact"
          data-testid="customer-general-section-name-value"
        >
          {name || '-'}
        </Text>
      </div>
      <div
        className="grid grid-cols-2 items-center px-6 py-4 text-ui-fg-subtle"
        data-testid="customer-general-section-company-row"
      >
        <Text
          size="small"
          leading="compact"
          weight="plus"
          data-testid="customer-general-section-company-label"
        >
          {t('fields.company')}
        </Text>
        <Text
          size="small"
          leading="compact"
          data-testid="customer-general-section-company-value"
        >
      ...
      <div
        className="grid grid-cols-2 items-center px-6 py-4 text-ui-fg-subtle"
        data-testid="customer-general-section-phone-row"
      >
        <Text
          size="small"
          leading="compact"
          weight="plus"
          data-testid="customer-general-section-phone-label"
        >
          {t('fields.phone')}
        </Text>
        <Text
          size="small"
          leading="compact"
          data-testid="customer-general-section-phone-value"
        >
          {customer.phone || '-'}
        </Text>
      </div>
