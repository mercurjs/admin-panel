  ...
  return (
    ...
    >
      <KeyboundForm
        ...
        data-testid="edit-customer-form-keybound"
      >
        <RouteDrawer.Body data-testid="edit-customer-form-body">
          <div
            className="flex flex-col gap-y-4"
            data-testid="edit-customer-form-fields"
          >
            <Form.Field
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="edit-customer-form-email-item">
                    <Form.Label data-testid="edit-customer-form-email-label">
                      {t('fields.email')}
                    </Form.Label>
                    <Form.Control data-testid="edit-customer-form-email-control">
                      ...
                      >
                        <Input
                          ...
                          data-testid="edit-customer-form-email-input"
                        />
                      </ConditionalTooltip>
                    </Form.Control>
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="edit-customer-form-first-name-item">
                    <Form.Label data-testid="edit-customer-form-first-name-label">
                      {t('fields.firstName')}
                    </Form.Label>
                    <Form.Control data-testid="edit-customer-form-first-name-control">
                      <Input
                        {...field}
                        data-testid="edit-customer-form-first-name-input"
                      />
                    </Form.Control>
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="edit-customer-form-last-name-item">
                    <Form.Label data-testid="edit-customer-form-last-name-label">
                      {t('fields.lastName')}
                    </Form.Label>
                    <Form.Control data-testid="edit-customer-form-last-name-control">
                      <Input
                        {...field}
                        data-testid="edit-customer-form-last-name-input"
                      />
                    </Form.Control>
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="edit-customer-form-company-name-item">
                    <Form.Label data-testid="edit-customer-form-company-name-label">
                      {t('fields.company')}
                    </Form.Label>
                    <Form.Control data-testid="edit-customer-form-company-name-control">
                      <Input
                        {...field}
                        data-testid="edit-customer-form-company-name-input"
                      />
                    </Form.Control>
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="edit-customer-form-phone-item">
                    <Form.Label data-testid="edit-customer-form-phone-label">
                      {t('fields.phone')}
                    </Form.Label>
        ...
        <RouteDrawer.Footer data-testid="edit-customer-form-footer">
          <div
            ...
            data-testid="edit-customer-form-footer-actions"
          >
            <RouteDrawer.Close asChild>
              <Button
                variant="secondary"
                size="small"
                data-testid="edit-customer-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
