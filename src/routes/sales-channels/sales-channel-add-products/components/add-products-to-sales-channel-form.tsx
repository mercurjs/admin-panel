...
export const AddProductsToSalesChannelForm = ({
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="sales-channel-add-products-form"
    >
      <KeyboundForm
      ...
      >
        <RouteFocusModal.Header data-testid="sales-channel-add-products-form-header">
          <div className="flex items-center justify-end gap-x-2">
            {form.formState.errors.product_ids && (
              <Hint
                variant="error"
                data-testid="sales-channel-add-products-form-error"
              >
        ...
        <RouteFocusModal.Body
          ...
          data-testid="sales-channel-add-products-form-body"
        >
          <_DataTable
            table={table}
            count={count}
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="sales-channel-add-products-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            ...
            <Button
              ...
              type="submit"
              isLoading={isPending}
              data-testid="sales-channel-add-products-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
