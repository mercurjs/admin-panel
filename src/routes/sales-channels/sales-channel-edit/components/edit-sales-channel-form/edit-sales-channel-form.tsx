...
export const EditSalesChannelForm = ({ salesChannel }: EditSalesChannelFormProps) => {
  ...
  return (
    <RouteDrawer.Form
      form={form}
      data-testid="sales-channel-edit-form"
    >
      <KeyboundForm
      ...
      >
        <RouteDrawer.Body
          ...
          data-testid="sales-channel-edit-form-body"
        >
          <Form.Field
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="sales-channel-edit-form-name-item">
                  <Form.Label data-testid="sales-channel-edit-form-name-label">
                    {t('fields.name')}
                  </Form.Label>
                  <Form.Control data-testid="sales-channel-edit-form-name-control">
                    <Input
                      {...field}
                      size="small"
                      data-testid="sales-channel-edit-form-name-input"
                    />
                  </Form.Control>
            ...
            render={({ field }) => {
              return (
                <Form.Item data-testid="sales-channel-edit-form-description-item">
                  <Form.Label
                    optional
                    data-testid="sales-channel-edit-form-description-label"
                  >
                  ...
                  <Form.Control data-testid="sales-channel-edit-form-description-control">
                    <Textarea
                      {...field}
                      data-testid="sales-channel-edit-form-description-input"
                    />
                  </Form.Control>
              ...
              return (
                <Form.Item data-testid="sales-channel-edit-form-enabled-item">
                  <div className="flex items-center justify-between">
                    <Form.Label data-testid="sales-channel-edit-form-enabled-label">
                      {t('general.enabled')}
                    </Form.Label>
                  ...
                  <Form.Hint data-testid="sales-channel-edit-form-enabled-hint">
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteDrawer.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="sales-channel-edit-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
            <Button
              ...
              type="submit"
              isLoading={isPending}
              data-testid="sales-channel-edit-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
