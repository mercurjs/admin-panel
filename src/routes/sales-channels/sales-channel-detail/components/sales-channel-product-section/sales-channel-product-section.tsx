...
export const SalesChannelProductSection = ({ salesChannel }: SalesChannelProductSectionProps) => {
  ...
  return (
    <Container
      ...
      data-testid="sales-channel-product-section-container"
    >
      <div
        className="flex items-center justify-between px-6 py-4"
        data-testid="sales-channel-product-section-header"
      >
        <Heading
          level="h2"
          data-testid="sales-channel-product-section-heading"
        >
          {t('products.domain')}
        </Heading>
        <Link to={`/settings/sales-channels/${salesChannel.id}/add-products`}>
          <Button
            size="small"
            variant="secondary"
            data-testid="sales-channel-product-section-add-button"
          >
            {t('general.add')}
          </Button>
        </Link>
