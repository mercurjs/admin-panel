...
export const CreateSalesChannelForm = () => {
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="sales-channel-create-form"
    >
      <KeyboundForm
      ...
      >
        ...
        <RouteFocusModal.Body
          ...
          data-testid="sales-channel-create-form-body"
        >
            ...
            <div className="flex w-full max-w-[720px] flex-col gap-y-8 px-2 py-16">
              <div data-testid="sales-channel-create-form-header-section">
                <Heading
                  ...
                  data-testid="sales-channel-create-form-heading"
                >
                ...
                <Text
                  ...
                  data-testid="sales-channel-create-form-hint"
                >
                    ...
                    render={({ field }) => {
                      return (
                        <Form.Item data-testid="sales-channel-create-form-name-item">
                          <Form.Label data-testid="sales-channel-create-form-name-label">
                            {t('fields.name')}
                          </Form.Label>
                          <Form.Control data-testid="sales-channel-create-form-name-control">
                            <Input
                              size="small"
                              {...field}
                              data-testid="sales-channel-create-form-name-input"
                            />
                          </Form.Control>
                  ...
                  render={({ field }) => {
                    return (
                      <Form.Item data-testid="sales-channel-create-form-description-item">
                        <Form.Label data-testid="sales-channel-create-form-description-label">
                          {t('fields.description')}
                        </Form.Label>
                        <Form.Control data-testid="sales-channel-create-form-description-control">
                          <Textarea
                            {...field}
                            data-testid="sales-channel-create-form-description-input"
                          />
                        </Form.Control>
                  ...
                  return (
                    <Form.Item data-testid="sales-channel-create-form-enabled-item">
                      <div className="flex items-center justify-between">
                        <Form.Label data-testid="sales-channel-create-form-enabled-label">
                          {t('general.enabled')}
                        </Form.Label>
                      ...
                      <Form.Hint data-testid="sales-channel-create-form-enabled-hint">
                        {t('salesChannels.enabledHint')}
                      </Form.Hint>
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="sales-channel-create-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            ...
            <Button
              ...
              type="submit"
              isLoading={isPending}
              data-testid="sales-channel-create-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
