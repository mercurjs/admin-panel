...
export const ProductTagEditForm = ({ productTag }: ProductTagEditFormProps) => {
  ...
  return (
    <RouteDrawer.Form
      form={form}
      data-testid="product-tag-edit-form"
    >
      <KeyboundForm
      ...
      >
        <RouteDrawer.Body
          ...
          data-testid="product-tag-edit-form-body"
        >
          <Form.Field
            ...
            render={({ field }) => (
              <Form.Item data-testid="product-tag-edit-form-value-item">
                <Form.Label data-testid="product-tag-edit-form-value-label">
                  {t('productTags.fields.value')}
                </Form.Label>
                <Form.Control data-testid="product-tag-edit-form-value-control">
                  <Input
                    {...field}
                    data-testid="product-tag-edit-form-value-input"
                  />
                </Form.Control>
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteDrawer.Close asChild>
              <Button
                ...
                size="small"
                type="button"
                data-testid="product-tag-edit-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
            <Button
              ...
              type="submit"
              isLoading={isPending}
              data-testid="product-tag-edit-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
