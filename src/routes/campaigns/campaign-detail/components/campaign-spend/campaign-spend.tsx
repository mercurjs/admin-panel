...
export const CampaignSpend = ({ campaign }: CampaignSpendProps) => {
  ...
  return (
    <Container
      ...
      data-testid="campaign-spend-container"
    >
      <div
        className="mb-2 grid grid-cols-[28px_1fr] items-center gap-x-3"
        data-testid="campaign-spend-header"
      >
        <div
          className="flex size-7 items-center justify-center rounded-md bg-ui-bg-base shadow-borders-base"
          data-testid="campaign-spend-icon-container"
        >
        ...
        <Heading
          ...
          data-testid="campaign-spend-heading"
        >
