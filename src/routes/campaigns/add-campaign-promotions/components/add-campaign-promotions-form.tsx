...
export const AddCampaignPromotionsForm = ({ campaign }: AddCampaignPromotionsFormProps) => {
  ...
  return (
    <RouteFocusModal.Form
      form={form}
      data-testid="campaign-add-promotions-form"
    >
      <KeyboundForm
      ...
      >
        <RouteFocusModal.Header data-testid="campaign-add-promotions-form-header">
          <div className="flex items-center justify-end gap-x-2">
            {form.formState.errors.promotion_ids && (
              <Hint
                variant="error"
                data-testid="campaign-add-promotions-form-error-hint"
              >
        ...
        <RouteFocusModal.Body
          ...
          data-testid="campaign-add-promotions-form-body"
        >
          <_DataTable
            table={table}
            count={count}
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteFocusModal.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="campaign-add-promotions-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            ...
            <Button
              ...
              type="submit"
              isLoading={isPending}
              data-testid="campaign-add-promotions-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
