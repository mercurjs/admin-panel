              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="campaign-edit-form-name-item">
                    <Form.Label data-testid="campaign-edit-form-name-label">
                      {t('fields.name')}
                    </Form.Label>
                    ...
                    <Form.Control data-testid="campaign-edit-form-name-control">
                      <Input
                        {...field}
                        data-testid="campaign-edit-form-name-input"
                      />
                    </Form.Control>
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="campaign-edit-form-description-item">
                    <Form.Label data-testid="campaign-edit-form-description-label">
                    ...
                    <Form.Control data-testid="campaign-edit-form-description-control">
                      <Input
                        {...field}
                        data-testid="campaign-edit-form-description-input"
                      />
                    </Form.Control>
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="campaign-edit-form-identifier-item">
                    <Form.Label data-testid="campaign-edit-form-identifier-label">
                    ...
                    <Form.Control data-testid="campaign-edit-form-identifier-control">
                      <Input
                        {...field}
                        data-testid="campaign-edit-form-identifier-input"
                      />
                    </Form.Control>
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="campaign-edit-form-starts-at-item">
                    <Form.Label data-testid="campaign-edit-form-starts-at-label">
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="campaign-edit-form-ends-at-item">
                    <Form.Label data-testid="campaign-edit-form-ends-at-label">
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteDrawer.Close asChild>
              <Button
                variant="secondary"
                size="small"
                data-testid="campaign-edit-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
