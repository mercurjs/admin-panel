...
export const ProductSalesChannelSection = ({ product }: ProductSalesChannelSectionProps) => {
  ...
  return (
    <Container
      ...
      data-testid="product-sales-channel-section"
    >
      <div
        className="flex items-center justify-between"
        data-testid="product-sales-channel-header"
      >
        <Heading
          level="h2"
          data-testid="product-sales-channel-title"
        >
      ...
      <div
        ...
        data-testid="product-sales-channels-content"
      >
        <div
          className="flex size-7 items-center justify-center rounded-md bg-ui-bg-base shadow-borders-base"
          data-testid="product-sales-channels-icon-container"
        >
          <div className="flex size-6 items-center justify-center rounded-[4px] bg-ui-bg-component">
            <Channels
              className="text-ui-fg-subtle"
              data-testid="product-sales-channels-icon"
            />
          </div>
        </div>
        {availableInSalesChannels.length > 0 ? (
          <div
            ...
            data-testid="product-sales-channels-list"
          >
            <Text
              size="small"
              leading="compact"
              data-testid="product-sales-channels-names"
            >
          ...
          <Text
            ...
            leading="compact"
            className="text-ui-fg-subtle"
            data-testid="product-sales-channels-empty"
          >
      ...
      <div data-testid="product-sales-channels-stats">
        <Text
          ...
          size="small"
          leading="compact"
          data-testid="product-sales-channels-stats-text"
        >
          <Trans
