...
function DetailsTab({ form, product }: DetailsTabProps) {
  ...
  return (
    <div
      ...
      data-testid="product-variant-create-form-details-tab"
    >
      <div className="flex w-full max-w-[720px] flex-col gap-y-8 px-8 py-16">
        <Heading
          level="h1"
          data-testid="product-variant-create-form-details-heading"
        >
          ...
          <Form.Field
            ...
            render={({ field }) => (
              <Form.Item data-testid="product-variant-create-form-title-item">
                <Form.Label data-testid="product-variant-create-form-title-label">
                  {t('fields.title')}
                </Form.Label>
                <Form.Control data-testid="product-variant-create-form-title-control">
                  <Input
                    {...field}
                    data-testid="product-variant-create-form-title-input"
                  />
                </Form.Control>
          ...
          <Form.Field
            ...
            render={({ field }) => (
              <Form.Item data-testid="product-variant-create-form-sku-item">
                <Form.Label
                  optional
                  data-testid="product-variant-create-form-sku-label"
                >
                  {t('fields.sku')}
                </Form.Label>
                <Form.Control data-testid="product-variant-create-form-sku-control">
                  <Input
                    {...field}
                    data-testid="product-variant-create-form-sku-input"
                  />
                </Form.Control>
            ...
            <Form.Field
              ...
              render={({ field: { value, onChange, ...field } }) => (
                <Form.Item data-testid={`product-variant-create-form-option-${option.title}-item`}>
                  <Form.Label
                    data-testid={`product-variant-create-form-option-${option.title}-label`}
                  >
                    {option.title}
                  </Form.Label>
                  <Form.Control
                    data-testid={`product-variant-create-form-option-${option.title}-control`}
                  >
                    <Combobox
                      value={value}
                      onChange={v => {
                  ...
                  <Form.ErrorMessage
                    data-testid={`product-variant-create-form-option-${option.title}-error`}
                  />
                </Form.Item>
              )}
            />
          ...
          <Form.Field
            ...
            render={({ field: { value, onChange, ...field } }) => (
              <Form.Item data-testid="product-variant-create-form-manage-inventory-item">
                <div
                  className="flex gap-x-3 rounded-lg bg-ui-bg-component p-4 shadow-elevation-card-rest"
                  data-testid="product-variant-create-form-manage-inventory-container"
                >
          ...
          <Form.Field
            ...
            render={({ field: { value, onChange, ...field } }) => (
              <Form.Item data-testid="product-variant-create-form-allow-backorder-item">
                <div
                  className="flex gap-x-3 rounded-lg bg-ui-bg-component p-4 shadow-elevation-card-rest"
                  data-testid="product-variant-create-form-allow-backorder-container"
                >
          ...
          <Form.Field
            ...
            render={({ field: { value, onChange, ...field } }) => (
              <Form.Item data-testid="product-variant-create-form-inventory-kit-item">
                <div
                  className="flex gap-x-3 rounded-lg bg-ui-bg-component p-4 shadow-elevation-card-rest"
                  data-testid="product-variant-create-form-inventory-kit-container"
                >
