...
export const ProductCreateGeneralSection = ({ form }: ProductCreateGeneralSectionProps) => {
  ...
  return (
    <div
      ...
      data-testid="product-create-general-section"
    >
      <div
        className="flex flex-col gap-y-2"
        data-testid="product-create-general-section-fields"
      >
        <div
          className="grid grid-cols-1 gap-4 md:grid-cols-3"
          data-testid="product-create-general-section-title-fields"
        >
          <Form.Field
            ...
            render={({ field }) => (
              <Form.Item data-testid="product-create-general-section-title-item">
                <Form.Label data-testid="product-create-general-section-title-label">
                ...
                <Form.Control data-testid="product-create-general-section-title-control">
                  <Input
                    ...
                    data-testid="product-create-general-section-title-input"
                  />
                </Form.Control>
              </Form.Item>
            )}
          ...
          <Form.Field
            ...
            render={({ field }) => (
              <Form.Item data-testid="product-create-general-section-subtitle-item">
                <Form.Label
                  optional
                  data-testid="product-create-general-section-subtitle-label"
                >
                ...
                <Form.Control data-testid="product-create-general-section-subtitle-control">
                  <Input
                    ...
                    data-testid="product-create-general-section-subtitle-input"
                  />
                </Form.Control>
              </Form.Item>
            )}
              ...
              <Form.Item data-testid="product-create-general-section-handle-item">
                ...
                <Form.Control data-testid="product-create-general-section-handle-control">
                  <HandleInput
                    ...
                    data-testid="product-create-general-section-handle-input"
                  />
                </Form.Control>
              </Form.Item>
            )}
      ...
      <Form.Field
        ...
        render={({ field }) => (
          <Form.Item data-testid="product-create-general-section-description-item">
            <Form.Label
              optional
              data-testid="product-create-general-section-description-label"
            >
