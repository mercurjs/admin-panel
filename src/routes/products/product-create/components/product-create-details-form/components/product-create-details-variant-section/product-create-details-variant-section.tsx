...
import { decorateVariantsWithDefaultValues } from '@routes/products/product-create/utils.ts';
import {
  Controller,
  useFieldArray,
  useWatch,
  ...
  return (
    ...
    >
      <div
        ...
        data-testid="product-create-variants-section-header"
      >
        <Heading
          level="h2"
          data-testid="product-create-variants-section-heading"
        >
                  ...
                  <div className="flex flex-col gap-y-6">
                    ...
                    {showInvalidOptionsMessage && (
                      <Alert
                        dismissible
                        variant="error"
                        data-testid="product-create-variants-section-options-error"
                      >
                    ...
                    <ul
                      ...
                      data-testid="product-create-variants-section-options-list"
                    >
            ...
            <div className="flex flex-col gap-y-6">
              ...
              {!showInvalidOptionsMessage && showInvalidVariantsMessage && (
                <Alert
                  dismissible
                  variant="error"
                  data-testid="product-create-variants-section-variants-error"
                >
              ...
              {variants.fields.length > 0 ? (
                <div
                  ...
                  data-testid="product-create-variants-section-variants-list"
                >
                  <div
