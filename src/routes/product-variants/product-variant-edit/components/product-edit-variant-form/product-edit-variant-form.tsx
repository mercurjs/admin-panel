...
import { transformNullableFormData, transformNullableFormNumber } from '@lib/form-helpers';
...
export const ProductEditVariantForm = ({ variant, product }: ProductEditVariantFormProps) => {
  ...
  return (
    <RouteDrawer.Form
      form={form}
      data-testid="product-variant-edit-form"
    >
      <KeyboundForm
                ...
                <Form.Field
                  ...
                  render={({ field: { value, onChange, ...field } }) => (
                    <Form.Item data-testid={`product-variant-edit-form-option-${optionKey}-item`}>
                      <Form.Label
                        data-testid={`product-variant-edit-form-option-${optionKey}-label`}
                      >
                        {option.title}
                      </Form.Label>
                      <Form.Control
                        data-testid={`product-variant-edit-form-option-${optionKey}-control`}
                      >
                        <div
                          data-testid={`product-variant-edit-form-option-${optionKey}-combobox-wrapper`}
                        >
                          <Combobox
                            value={value}
                            onChange={v => {
                      ...
                      <Form.ErrorMessage
                        data-testid={`product-variant-edit-form-option-${optionKey}-error`}
                      />
                    </Form.Item>
                  )}
                />
