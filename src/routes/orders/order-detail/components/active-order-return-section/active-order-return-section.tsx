...
export const ActiveOrderReturnSection = ({ orderPreview }: ActiveOrderReturnSectionProps) => {
  ...
  const { mutateAsync: cancelReturn } = useCancelReturnRequest(returnId, orderPreview.id);
        ...
        <div className="flex w-full flex-row justify-between">
          <div>
            <div
              ...
              data-testid="active-order-return-header"
            >
              <ArrowUturnLeft className="text-ui-fg-subtle" />
              <Heading
                level="h2"
                data-testid="active-order-return-heading"
              >
            ...
            <div
              ...
              data-testid="active-order-return-description"
            >
          ...
          <div
            ...
            data-testid="active-order-return-actions"
          >
            <Button
              size="small"
              variant="secondary"
              onClick={onCancelReturn}
              data-testid="active-order-return-cancel-button"
            >
            ...
            <Button
              ...
              data-testid="active-order-return-continue-button"
            >
              {t('actions.continue')}
            </Button>
          </div>
