...
export const ActiveOrderClaimSection = ({ orderPreview }: ActiveOrderClaimSectionProps) => {
  const { t } = useTranslation();
  const claimId = orderPreview?.order_change?.claim_id;

  const { mutateAsync: cancelClaim } = useCancelClaimRequest(claimId, orderPreview.id);
        ...
        <div className="flex w-full flex-row justify-between">
          <div>
            <div
              ...
              data-testid="active-order-claim-header"
            >
              <ExclamationCircle className="text-ui-fg-subtle" />
              <Heading
                level="h2"
                data-testid="active-order-claim-heading"
              >
            ...
            <div
              ...
              data-testid="active-order-claim-description"
            >
          ...
          <div
            ...
            data-testid="active-order-claim-actions"
          >
            <Button
              size="small"
              variant="secondary"
              onClick={onCancelClaim}
              data-testid="active-order-claim-cancel-button"
            >
            ...
            <Button
              ...
              data-testid="active-order-claim-continue-button"
            >
              {t('actions.continue')}
            </Button>
          </div>
