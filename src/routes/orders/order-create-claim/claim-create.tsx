...
export const ClaimCreate = () => {
  ...
  const { order } = useOrder(id!, {
    fields: `${DEFAULT_FIELDS},*items.variant.product.collection,*items.variant.product.categories,*items.variant.inventory_items.inventory.location_levels`
  });

  const { order: preview } = useOrderPreview(id!, {
    fields:
      '*items.variant,*items.variant.inventory_items.inventory,+items.variant.inventory_items.inventory.location_levels.available_quantity'
  });
