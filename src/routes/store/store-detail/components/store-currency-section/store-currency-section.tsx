...
export const StoreCurrencySection = ({ store }: StoreCurrencySectionProps) => {
  ...
  return (
    <Container
      ...
      data-testid="store-currency-section-container"
    >
      <div
        className="flex items-center justify-between px-6 py-4"
        data-testid="store-currency-section-header"
      >
        <Heading
          level="h2"
          data-testid="store-currency-section-heading"
        >
          {t('store.currencies')}
        </Heading>
        <ActionMenu
      ...
      <CommandBar
        ...
        data-testid="store-currency-section-command-bar"
      >
