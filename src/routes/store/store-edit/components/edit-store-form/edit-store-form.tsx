    ...
    >
      ...
      >
        <RouteDrawer.Body
          ...
          data-testid="store-edit-form-body"
        >
            ...
            <Form.Field
              ...
              render={({ field }) => (
                <Form.Item data-testid="store-edit-form-name-item">
                  <Form.Label data-testid="store-edit-form-name-label">
                    {t('fields.name')}
                  </Form.Label>
                  <Form.Control data-testid="store-edit-form-name-control">
                    <Input
                      placeholder="ACME"
                      {...field}
                      data-testid="store-edit-form-name-input"
                    />
                  </Form.Control>
              ...
              render={({ field: { onChange, ...field } }) => {
                return (
                  <Form.Item data-testid="store-edit-form-currency-item">
                    <Form.Label data-testid="store-edit-form-currency-label">
                    ...
                    <Form.Control data-testid="store-edit-form-currency-control">
                      ...
                      >
                        <Select.Trigger
                          ref={field.ref}
                          data-testid="store-edit-form-currency-select-trigger"
                        >
                          <Select.Value />
                        </Select.Trigger>
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="store-edit-form-region-item">
                    <Form.Label data-testid="store-edit-form-region-label">
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="store-edit-form-sales-channel-item">
                    <Form.Label data-testid="store-edit-form-sales-channel-label">
              ...
              render={({ field }) => {
                return (
                  <Form.Item data-testid="store-edit-form-location-item">
                    <Form.Label data-testid="store-edit-form-location-label">
          ...
          <div className="flex items-center justify-end gap-x-2">
            <RouteDrawer.Close asChild>
              <Button
                size="small"
                variant="secondary"
                data-testid="store-edit-form-cancel-button"
              >
                {t('actions.cancel')}
              </Button>
            </RouteDrawer.Close>
            <Button
              ...
              isLoading={isPending}
              type="submit"
              data-testid="store-edit-form-save-button"
            >
              {t('actions.save')}
            </Button>
          </div>
