...
const UpsertDefaultCommissionRuleForm = ({ onSuccess, rule }: Props) => {
  ...
  return (
    <form
      onSubmit={onSubmit}
      data-testid="commission-upsert-default-rule-form"
    >
      <fieldset
        className="my-4"
        data-testid="commission-upsert-default-rule-form-include-tax-fieldset"
      >
        <div
          className="flex items-center gap-x-2"
          data-testid="commission-upsert-default-rule-form-include-tax-container"
        >
          <Switch
            id="include_tax"
            checked={includeTax}
          ...
          />
          <Label data-testid="commission-upsert-default-rule-form-include-tax-label">
            Commission charged including tax
          </Label>
        </div>
      </fieldset>
      <fieldset
        className="my-4"
        data-testid="commission-upsert-default-rule-form-rate-type-fieldset"
      >
        <legend
          className="mb-2"
          data-testid="commission-upsert-default-rule-form-rate-type-legend"
        >
          Fee type
        </legend>
        <div
          className="flex items-center gap-x-2"
          data-testid="commission-upsert-default-rule-form-rate-type-container"
        >
          <Label data-testid="commission-upsert-default-rule-form-rate-type-flat-label">
            Flat fee
          </Label>
          <Switch
            id="rate_type"
          ...
          />
          <Label data-testid="commission-upsert-default-rule-form-rate-type-percentage-label">
            Percentage
          </Label>
        </div>
      </fieldset>
      <fieldset
        className="my-4"
        data-testid="commission-upsert-default-rule-form-rate-value-fieldset"
      >
        <legend
          className="mb-2"
          data-testid="commission-upsert-default-rule-form-rate-value-legend"
        >
          Fee value
        </legend>
        {rateType === 'percentage' && (
        ...
        {rateType === 'flat' &&
          ...
          currencies.map(currency => {
            return (
              <div
                key={currency}
                data-testid={`commission-upsert-default-rule-form-rate-flat-value-${currency}`}
              >
                <Label
                  data-testid={`commission-upsert-default-rule-form-rate-flat-value-${currency}-label`}
                >
      ...
      {rateType === 'percentage' && (
        <>
          <fieldset
            className="my-4"
            data-testid="commission-upsert-default-rule-form-min-commission-fieldset"
          >
            <div
              className="flex items-center gap-x-2"
              data-testid="commission-upsert-default-rule-form-min-commission-container"
            >
              <Label data-testid="commission-upsert-default-rule-form-min-commission-label">
            ...
            {minCommissionEnabled &&
              ...
              currencies.map(currency => {
                return (
                  <div
                    key={currency}
                    data-testid={`commission-upsert-default-rule-form-min-commission-${currency}`}
                  >
                    <Label
                      data-testid={`commission-upsert-default-rule-form-min-commission-${currency}-label`}
                    >
                      {currency.toUpperCase()}
                    </Label>
                    <Input
                      ...
                      type="number"
                      value={
                        minCommission.filter(v => v.currency_code === currency)[0]?.amount || 0
                      }
                      onChange={e =>
          ...
          <fieldset
            className="my-4"
            data-testid="commission-upsert-default-rule-form-max-commission-fieldset"
          >
            <div
              className="flex items-center gap-x-2"
              data-testid="commission-upsert-default-rule-form-max-commission-container"
            >
              <Label data-testid="commission-upsert-default-rule-form-max-commission-label">
            ...
            {maxCommissionEnabled &&
              ...
              currencies.map(currency => {
                return (
                  <div
                    key={currency}
                    data-testid={`commission-upsert-default-rule-form-max-commission-${currency}`}
                  >
                    <Label
                      data-testid={`commission-upsert-default-rule-form-max-commission-${currency}-label`}
                    >
                      {currency.toUpperCase()}
                    </Label>
                    <Input
                      ...
                      type="number"
                      value={
                        maxCommission.filter(v => v.currency_code === currency)[0]?.amount || 0
                      }
                      onChange={e =>
      ...
      <Button
        type="submit"
        isLoading={loading}
        data-testid="commission-upsert-default-rule-form-submit-button"
      >
        Create
      </Button>
    </form>
