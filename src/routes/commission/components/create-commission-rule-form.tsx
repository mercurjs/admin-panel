...
import { Button, Drawer, Input, Label, Select, Switch, toast } from '@medusajs/ui';
...
const referenceRequirements = {
  ...
  needsType: (reference: ReferenceTypeValue) =>
    (
      [ReferenceType.PRODUCT_TYPE, ReferenceType.SELLER_PRODUCT_TYPE] as ReferenceTypeValue[]
    ).includes(reference),
...
const validateRateFields = (
  ...
  if (data.rateType === RateType.FLAT) {
    ...
    const hasValidValue = Object.values(data.rateFlatValue).some(value => value > 0);
...
const CreateCommissionRuleForm = ({ onSuccess }: Props) => {
  ...
  const showProductTypes = useMemo(
    () =>
      reference === ReferenceType.PRODUCT_TYPE || reference === ReferenceType.SELLER_PRODUCT_TYPE,
    [reference]
  );
  ...
  const { mutateAsync: createCommissionRule, isPending } = useCreateCommisionRule({});
  ...
  const handleSubmit = form.handleSubmit(async data => {
    ...
    const rule_payload = {
      ...
      rate: {
        type: data.rateType,
        percentage_rate: data.rateType === RateType.PERCENTAGE ? data.ratePercentValue : undefined,
        include_tax: data.includeTax,
        price_set:
          data.rateType === RateType.FLAT ? convertRecordToArray(data.rateFlatValue) : undefined,
  ...
  return (
    <Form
      {...form}
      data-testid="commission-create-rule-form"
    >
      <KeyboundForm
      ...
      >
        <Drawer.Body
          ...
          data-testid="commission-create-rule-form-body"
        >
          <Form.Field
            control={form.control}
            name="name"
            render={({ field }) => (
              <Form.Item data-testid="commission-create-rule-form-name-item">
                <Form.Label data-testid="commission-create-rule-form-name-label">
                  Rule Name
                </Form.Label>
                <Form.Control data-testid="commission-create-rule-form-name-control">
                  <Input
                    ...
                    data-testid="commission-create-rule-form-name-input"
                  />
                </Form.Control>
          ...
          <Form.Field
            ...
            render={({ field: { onChange, ref, ...field } }) => (
              <Form.Item data-testid="commission-create-rule-form-reference-item">
                <Form.Label data-testid="commission-create-rule-form-reference-label">
                  Rule Type
                </Form.Label>
                <Form.Control data-testid="commission-create-rule-form-reference-control">
                  <Select
                    ...
                    data-testid="commission-create-rule-form-reference-select"
                  >
                    <Select.Trigger
                      ref={ref}
                      data-testid="commission-create-rule-form-reference-trigger"
                    >
                      <Select.Value placeholder="Select rule type" />
                    </Select.Trigger>
                    <Select.Content data-testid="commission-create-rule-form-reference-content">
                      <Select.Item
                        value={ReferenceType.SELLER}
                        data-testid="commission-create-rule-form-reference-option-seller"
                      >
                        Seller
                      </Select.Item>
                      <Select.Item
                        value={ReferenceType.PRODUCT_TYPE}
                        data-testid="commission-create-rule-form-reference-option-product-type"
                      >
                        Product type
                      </Select.Item>
                      <Select.Item
                        value={ReferenceType.PRODUCT_CATEGORY}
                        data-testid="commission-create-rule-form-reference-option-product-category"
                      >
                        Product category
                      </Select.Item>
                      <Select.Item
                        value={ReferenceType.SELLER_PRODUCT_TYPE}
                        data-testid="commission-create-rule-form-reference-option-seller-product-type"
                      >
                        Seller + Product type
                      </Select.Item>
                      <Select.Item
            ...
            <Form.Field
              ...
              render={({ field: { onChange, ref, ...field } }) => (
                <Form.Item data-testid="commission-create-rule-form-seller-item">
                  <Form.Label data-testid="commission-create-rule-form-seller-label">
                    Seller
                  </Form.Label>
                  <Form.Control data-testid="commission-create-rule-form-seller-control">
                    <Select
                      ...
                      {...field}
                      onValueChange={onChange}
                      data-testid="commission-create-rule-form-seller-select"
                    >
                      <Select.Trigger
                        ref={ref}
                        data-testid="commission-create-rule-form-seller-trigger"
                      >
                      ...
                      <Select.Content data-testid="commission-create-rule-form-seller-content">
                        {sellers.map(s => (
                          <Select.Item
                            key={s.id}
                            value={s.id}
                            data-testid={`commission-create-rule-form-seller-option-${s.id}`}
                          >
                            {s.name}
                          </Select.Item>
                        ))}
            ...
            <Form.Field
              ...
              render={({ field: { onChange, ref, ...field } }) => (
                <Form.Item data-testid="commission-create-rule-form-category-item">
                  <Form.Label data-testid="commission-create-rule-form-category-label">
                    Product Category
                  </Form.Label>
                  <Form.Control data-testid="commission-create-rule-form-category-control">
                    <Select
                      ...
                      {...field}
                      onValueChange={onChange}
                      data-testid="commission-create-rule-form-category-select"
                    >
                      <Select.Trigger
                        ref={ref}
                        data-testid="commission-create-rule-form-category-trigger"
                      >
                      ...
                      <Select.Content data-testid="commission-create-rule-form-category-content">
                        {product_categories.map(c => (
                          <Select.Item
                            key={c.id}
                            value={c.id}
                            data-testid={`commission-create-rule-form-category-option-${c.id}`}
                          >
                            {c.name}
                          </Select.Item>
                        ))}
            ...
            <Form.Field
              ...
              render={({ field: { onChange, ref, ...field } }) => (
                <Form.Item data-testid="commission-create-rule-form-type-item">
                  <Form.Label data-testid="commission-create-rule-form-type-label">
                    Product Type
                  </Form.Label>
                  <Form.Control data-testid="commission-create-rule-form-type-control">
                    <Select
                      ...
                      {...field}
                      onValueChange={onChange}
                      data-testid="commission-create-rule-form-type-select"
                    >
                      <Select.Trigger
                        ref={ref}
                        data-testid="commission-create-rule-form-type-trigger"
                      >
                      ...
                      <Select.Content data-testid="commission-create-rule-form-type-content">
                        {product_types.map(t => (
                          <Select.Item
                            key={t.id}
                            value={t.id}
                            data-testid={`commission-create-rule-form-type-option-${t.id}`}
                          >
                            {t.value}
                          </Select.Item>
                        ))}
          ...
          <Form.Field
            ...
            render={({ field: { onChange, value } }) => (
              <Form.Item data-testid="commission-create-rule-form-rate-type-item">
                <Form.Label data-testid="commission-create-rule-form-rate-type-label">
                  Fee Type
                </Form.Label>
                <Form.Control data-testid="commission-create-rule-form-rate-type-control">
                  <div
                    className="flex items-center gap-x-2"
                    data-testid="commission-create-rule-form-rate-type-switch-container"
                  >
                    <Label data-testid="commission-create-rule-form-rate-type-flat-label">
                      Flat fee
                    </Label>
                    <Switch
                    ...
                    />
                    <Label data-testid="commission-create-rule-form-rate-type-percentage-label">
                      Percentage
                    </Label>
                  </div>
                </Form.Control>
            ...
            <Form.Field
              ...
              render={({ field: { onChange, value, ...field } }) => (
                <Form.Item data-testid="commission-create-rule-form-rate-percent-value-item">
                  <Form.Label data-testid="commission-create-rule-form-rate-percent-value-label">
                    Percentage Value
                  </Form.Label>
            ...
            <Form.Field
              ...
              render={({ field: { value = {}, onChange } }) => (
                <Form.Item data-testid="commission-create-rule-form-rate-flat-value-item">
                  <Form.Label data-testid="commission-create-rule-form-rate-flat-value-label">
                    Flat Fee Values
                  </Form.Label>
                  <div
                    className="flex flex-col gap-y-2"
                    data-testid="commission-create-rule-form-rate-flat-value-container"
                  >
                    {currencies.map(currency => (
                      <div
                        key={currency}
                        data-testid={`commission-create-rule-form-rate-flat-value-${currency}`}
                      >
                        <Label
                          className="mb-1"
                          data-testid={`commission-create-rule-form-rate-flat-value-${currency}-label`}
                        >
                ...
                <Form.Field
                  ...
                  render={({ field: { value = {}, onChange } }) => (
                    <Form.Item data-testid="commission-create-rule-form-min-commission-item">
                      <Form.Label data-testid="commission-create-rule-form-min-commission-label">
                        Minimum Commission Values
                      </Form.Label>
                      <div
                        className="flex flex-col gap-y-2"
                        data-testid="commission-create-rule-form-min-commission-container"
                      >
                        {currencies.map(currency => (
                          <div
                            key={currency}
                            data-testid={`commission-create-rule-form-min-commission-${currency}`}
                          >
                            <Label
                              className="mb-1"
                              data-testid={`commission-create-rule-form-min-commission-${currency}-label`}
                            >
                              {currency.toUpperCase()}
                            </Label>
                            <Input
                ...
                <Form.Field
                  ...
                  render={({ field: { value = {}, onChange } }) => (
                    <Form.Item data-testid="commission-create-rule-form-max-commission-item">
                      <Form.Label data-testid="commission-create-rule-form-max-commission-label">
                        Maximum Commission Values
                      </Form.Label>
                      <div
                        className="flex flex-col gap-y-2"
                        data-testid="commission-create-rule-form-max-commission-container"
                      >
                        {currencies.map(currency => (
                          <div
                            key={currency}
                            data-testid={`commission-create-rule-form-max-commission-${currency}`}
                          >
                            <Label
                              className="mb-1"
                              data-testid={`commission-create-rule-form-max-commission-${currency}-label`}
                            >
                              {currency.toUpperCase()}
                            </Label>
                            <Input
        ...
        <Drawer.Footer
          className="mt-8 flex items-center justify-end gap-x-2"
          data-testid="commission-create-rule-form-footer"
        >
          <Button
            type="submit"
            isLoading={isPending}
            size="small"
            data-testid="commission-create-rule-form-create-button"
          >
            Create
          </Button>
        </Drawer.Footer>
