import type { AdminCommissionAggregate, AdminCommissionPriceValue } from '@custom-types/commission';
  ...
  <Table data-testid="commission-detail-table">
    <Table.Body data-testid="commission-detail-table-body">
      <Table.Row data-testid="commission-detail-table-row-default-commission">
        <Table.Cell data-testid="commission-detail-table-row-default-commission-label">
          Default commission
        </Table.Cell>
        <Table.Cell data-testid="commission-detail-table-row-default-commission-value">
          {commissionRule?.fee_value}{' '}
        </Table.Cell>
      </Table.Row>
      <Table.Row data-testid="commission-detail-table-row-minimum-commission">
        <Table.Cell data-testid="commission-detail-table-row-minimum-commission-label">
      ...
      <Table.Row data-testid="commission-detail-table-row-maximum-commission">
        <Table.Cell data-testid="commission-detail-table-row-maximum-commission-label">
      ...
      <Table.Row data-testid="commission-detail-table-row-include-tax">
        <Table.Cell data-testid="commission-detail-table-row-include-tax-label">
          Commission charged including tax
        </Table.Cell>
        <Table.Cell data-testid="commission-detail-table-row-include-tax-value">
          <StatusBadge color={commissionRule?.include_tax ? 'green' : 'grey'}>
