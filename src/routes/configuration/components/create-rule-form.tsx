...
const CreateConfigurationRuleForm = ({ onSuccess }: Props) => {
  ...
  return (
    <form
      onSubmit={onSubmit}
      data-testid="configuration-create-rule-form"
    >
      <fieldset
        className="my-4"
        data-testid="configuration-create-rule-form-rule-type-field"
      >
        <legend
          className="mb-2"
          data-testid="configuration-create-rule-form-rule-type-legend"
        >
          Rule type
        </legend>
        <Select
        ...
        >
          ...
          <Select.Content data-testid="configuration-create-rule-form-rule-type-content">
            <Select.Item
              value="global_product_catalog"
              data-testid="configuration-create-rule-form-rule-type-option-global-product-catalog"
            >
              global_product_catalog
            </Select.Item>
            <Select.Item
              value="require_product_approval"
              data-testid="configuration-create-rule-form-rule-type-option-require-product-approval"
            >
              require_product_approval
            </Select.Item>
            <Select.Item
              value="product_request_enabled"
              data-testid="configuration-create-rule-form-rule-type-option-product-request-enabled"
            >
              product_request_enabled
            </Select.Item>
            <Select.Item
              value="product_import_enabled"
              data-testid="configuration-create-rule-form-rule-type-option-product-import-enabled"
            >
              product_import_enabled
            </Select.Item>
          </Select.Content>
      ...
      <fieldset
        className="my-4"
        data-testid="configuration-create-rule-form-enabled-field"
      >
      ...
      <Button
        type="submit"
        isLoading={loading}
        data-testid="configuration-create-rule-form-create-button"
      >
        Create
      </Button>
    </form>
