...
export const PromotionGeneralSection = ({ promotion }: PromotionGeneralSectionProps) => {
  ...
  return (
    <Container
      ...
      data-testid="promotion-general-section-container"
    >
      <div
        className="flex items-center justify-between px-6 py-4"
        data-testid="promotion-general-section-header"
      >
        ...
        <div className="flex items-center gap-x-2">
          <StatusBadge
            color={color}
            data-testid="promotion-general-section-status"
          >
            {text}
          </StatusBadge>
          <ActionMenu
      ...
      <div
        ...
        data-testid="promotion-general-section-method"
      >
        <Text
          size="small"
          weight="plus"
          leading="compact"
          data-testid="promotion-general-section-method-label"
        >
        ...
        <Text
          ...
          data-testid="promotion-general-section-method-value"
        >
      ...
      <div
        ...
        data-testid="promotion-general-section-code-field"
      >
        <Text
          size="small"
          weight="plus"
          leading="compact"
          data-testid="promotion-general-section-code-label"
        >
          {t('fields.code')}
        </Text>
      ...
      <div
        className="grid grid-cols-2 items-start px-6 py-4 text-ui-fg-subtle"
        data-testid="promotion-general-section-type"
      >
        <Text
          size="small"
          weight="plus"
          leading="compact"
          data-testid="promotion-general-section-type-label"
        >
        ...
        <Text
          ...
          data-testid="promotion-general-section-type-value"
        >
          {promotion.type}
        </Text>
      </div>
      ...
      <div
        className="grid grid-cols-2 items-start px-6 py-4 text-ui-fg-subtle"
        data-testid="promotion-general-section-value"
      >
        <Text
          size="small"
          weight="plus"
          leading="compact"
          data-testid="promotion-general-section-value-label"
        >
        ...
        <div
          ...
          data-testid="promotion-general-section-value-content"
        >
          <Text
            className="inline"
            size="small"
            leading="compact"
            data-testid="promotion-general-section-value-text"
          >
            {displayValue || '-'}
          </Text>
          {promotion?.application_method?.type === 'fixed' && (
            <Badge
              size="2xsmall"
              rounded="full"
              data-testid="promotion-general-section-value-currency"
            >
      ...
      <div
        className="grid grid-cols-2 items-start px-6 py-4 text-ui-fg-subtle"
        data-testid="promotion-general-section-allocation"
      >
        <Text
          size="small"
          weight="plus"
          leading="compact"
          data-testid="promotion-general-section-allocation-label"
        >
        ...
        <Text
          ...
          leading="compact"
          className="text-pretty capitalize"
          data-testid="promotion-general-section-allocation-value"
        >
      ...
      {promotion.application_method?.type === 'fixed' && (
        <div
          className="grid grid-cols-2 items-start px-6 py-4 text-ui-fg-subtle"
          data-testid="promotion-general-section-tax-inclusive"
        >
          <Text
            size="small"
            weight="plus"
            leading="compact"
            data-testid="promotion-general-section-tax-inclusive-label"
          >
          ...
          <div
            className="flex items-center gap-x-2"
            data-testid="promotion-general-section-tax-inclusive-value"
          >
            <Text
              className="inline"
              size="small"
